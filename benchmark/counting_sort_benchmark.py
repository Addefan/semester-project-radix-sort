"""
Контрольное тестирование сортировки подсчётом
"""
import argparse
...
from src.counting_sort import counting_sort  # noqa: E402

DEFAULT_DESCRIPTION = 'Counting sort benchmark script'
DEFAULT_TRIALS = 10
...
def parse_args():
    ...
    parser.add_argument('input',
                        type=str,
                        help='input CSV file, e.g. dataset/data/counting_sort/01/100.csv')
